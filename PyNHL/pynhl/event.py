...
class Event:
    ...
    def get_players(self, event):
        ...
        if 'Blocked' in self.type_of_event:
            ...
            self.player_for, self.player_against = event['players'][1]['player']['fullName'], \
    ...
    def get_time(self, event):
        ...
        self.time = int(datetime.timedelta(minutes=temp.minute, seconds=temp.second).total_seconds())
        return self
